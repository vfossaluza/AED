...
\hypersetup{
  ...
  pdfauthor={Victor Fossaluza e Gabriela Scarpini},
  hidelinks,
...
Esse material está sendo desenvolvido para apoiar as aulas de Análise Exploratória de Dados. O objetivo principal da apostila é auxiliar os estudantes na compreensão dos conceitos teóricos, com capítulos curtos e por meio de exercícios ao final de cada capítulo.
...
\item
  Grolemund, G. Wickham, H. R for Data Science. \href{https://r4ds.had.co.nz/index.html}{link}
\end{itemize}
...
\hypertarget{comentuxe1rios-sobre-probabilidade-e-aleatoriedade}{%
...
\hypertarget{populauxe7uxe3o-x-amostra-probabilidade-x-estatuxedstica}{%
...
\hypertarget{comparauxe7uxe3o-com-outras-linguagens-estatuxedsticas}{%
...
\item
  Para destacar: \emph{Texto em itálico} ou \textbf{Texto em negrito}.
\end{itemize}
...
\tightlist
\item
  Blocos de códigos (chunks), que são delimitados por três crases (```) e é onde você pode escrever e executar os comandos em R. Eles permitem integrar o código diretamente ao documento, gerando tabelas, gráficos, etc. Um atalho para cria-lo é com CTRL+ALT+I.
\end{enumerate}
...
\hypertarget{operadores-buxe1sicos}{%
...
\hypertarget{funuxe7uxf5es-buxe1sicas-e-pacotes}{%
...
\hypertarget{processos-de-obtenuxe7uxe3o-importauxe7uxe3o-organizauxe7uxe3o-e-transformauxe7uxe3o}{%
...
\toprule
\cellcolor[HTML]{D3D3D3}{\textcolor{black}{\textbf{ordem\_lancamento}}} & \cellcolor[HTML]{D3D3D3}{\textcolor{black}{\textbf{filme}}} & \cellcolor[HTML]{D3D3D3}{\textcolor{black}{\textbf{data\_lancamento}}} & \cellcolor[HTML]{D3D3D3}{\textcolor{black}{\textbf{duracao}}} & \cellcolor[HTML]{D3D3D3}{\textcolor{black}{\textbf{bilheteria\_mundial}}} & \cellcolor[HTML]{D3D3D3}{\textcolor{black}{\textbf{genero}}}\\
\midrule
\cellcolor{gray!10}{1} & \cellcolor{gray!10}{Toy Story} & \cellcolor{gray!10}{1995-11-22} & \cellcolor{gray!10}{81} & \cellcolor{gray!10}{373554033} & \cellcolor{gray!10}{Aventura}\\
2 & Vida de inseto & 1998-11-25 & 95 & 363258859 & Comédia\\
\cellcolor{gray!10}{3} & \cellcolor{gray!10}{Toy Story 2} & \cellcolor{gray!10}{1999-11-24} & \cellcolor{gray!10}{92} & \cellcolor{gray!10}{497374776} & \cellcolor{gray!10}{Aventura}\\
4 & Monstros S. A. & 2001-11-02 & 92 & 632316649 & Aventura\\
\cellcolor{gray!10}{5} & \cellcolor{gray!10}{Procurando Nemo} & \cellcolor{gray!10}{2003-05-30} & \cellcolor{gray!10}{100} & \cellcolor{gray!10}{871014978} & \cellcolor{gray!10}{Comédia}\\
\addlinespace
6 & Os Incríveis & 2004-11-05 & 115 & 631606713 & Ação\\
\cellcolor{gray!10}{7} & \cellcolor{gray!10}{Carros} & \cellcolor{gray!10}{2006-06-09} & \cellcolor{gray!10}{117} & \cellcolor{gray!10}{461983149} & \cellcolor{gray!10}{Esporte}\\
8 & Ratatouille & 2007-06-29 & 111 & 623726085 & Aventura\\
\cellcolor{gray!10}{9} & \cellcolor{gray!10}{WALL-E} & \cellcolor{gray!10}{2008-06-27} & \cellcolor{gray!10}{98} & \cellcolor{gray!10}{521311860} & \cellcolor{gray!10}{Ficção Científica}\\
10 & Up Altas Aventuras & 2009-05-29 & 96 & 735099082 & Drama\\
\bottomrule
\end{tabular}}
\endgroup{}
\end{table}

A tabela acima é uma versão reduzida do banco de dados ``filmes\_pixar'', disponível para download \textbf{\href{filmes_pixar.csv}{aqui}}.
...
\hypertarget{medidas_uma_variavel_5}{%
...
\hypertarget{desvio-muxe9dio-ou-absoluto}{%
...
\hypertarget{medidas-de-ordem}{%
\section{Medidas de ordem}\label{medidas-de-ordem}}

\hypertarget{quartis-e-quantis}{%
...
\hypertarget{distuxe2ncia-ou-amplitude-interquartis}{%
...
\hypertarget{desvio-mediano-absoluto}{%
...
\hypertarget{coeficiente-de-assimetria-de-bowley}{%
...
\hypertarget{coeficiente-de-assimetria-de-pearson-1}{%
...
\hypertarget{coeficiente-de-assimetria-de-pearson-2}{%
...
\hypertarget{coeficiente-de-assimetria-de-fisher-pearson}{%
\subsection{Coeficiente de Assimetria de Fisher-Pearson}\label{coeficiente-de-assimetria-de-fisher-pearson}}

\[g_1 = m_3/m_2^{3/2}\]

\hypertarget{coeficiente-de-assimetria-de-fisher-pearson-ajustado}{%
...
\hypertarget{calculo-de-medidas-no-r}{%
...
\begin{center}\includegraphics{AED_files/figure-latex/barras_genero-1} \end{center}
...
\begin{center}\includegraphics{AED_files/figure-latex/barras_duracao-1} \end{center}
...
\hypertarget{gruxe1ficos-e-simetria}{%
...
\hypertarget{duas-variuxe1veis-categuxf3ricas}{%
...
\hypertarget{medidas_duas_va}{%
\chapter{Medidas de duas variáveis}\label{medidas_duas_va}}

\hypertarget{tabela-de-continguxeancia-de-frequuxeancias}{%
...
\hypertarget{correlauxe7uxe3o-amostral}{%
...
\hypertarget{qui-quadrado-de-pearson}{%
...
\hypertarget{medidas-de-associauxe7uxe3o-baseadas-no-qui-quadrado}{%
...
\hypertarget{coeficiente-de-continguxeancia-de-pearson}{%
...
\hypertarget{coeficiente-de-tcschupov}{%
...
\hypertarget{outras-medidas-de-associauxe7uxe3o}{%
...
\hypertarget{risco-atribuuxedvel}{%
...
\hypertarget{razuxe3o-de-chances-odds-ratio}{%
...
\hypertarget{medidas-para-testes-de-diagnuxf3stico}{%
...
\hypertarget{valor-preditivo-positivo}{%
...
\hypertarget{valor-preditivo-negativo}{%
...
\hypertarget{outros-gruxe1ficos-incompleto}{%
\chapter{Outros Gráficos (incompleto)}\label{outros-gruxe1ficos-incompleto}}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\hypertarget{gruxe1fico-de-bolhas}{%
...
\hypertarget{diferentes-gruxe1ficos-de-barras}{%
...
\begin{center}\includegraphics{AED_files/figure-latex/unnamed-chunk-4-1} \end{center}

\hypertarget{barras-empilhadas}{%
\subsection{Barras empilhadas}\label{barras-empilhadas}}

\hypertarget{barras-100-empilhadas}{%
\subsection{Barras 100\% empilhadas}\label{barras-100-empilhadas}}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\hypertarget{gruxe1fico-de-velocuxedmetro}{%
\section{Gráfico de velocímetro}\label{gruxe1fico-de-velocuxedmetro}}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\hypertarget{gruxe1fico-mosauxedco}{%
...
\hypertarget{regressuxe3o-linear-incompleto}{%
