...
% \usepackage[pdftex,plainpages=false,pdfpagelabels,pagebackref,colorlinks=true,citecolor=DarkGreen,linkcolor=NavyBlue,urlcolor=DarkRed,filecolor=DarkGreen,bookmarksopen=true,pdfnewwindow]{hyperref} % links coloridos
