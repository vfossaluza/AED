...
\emph{Obs.:} Para o item (b) e (c) faça à mão e depois repita o exercício no R. Para a parte do R os dados da tabela estão \textbf{\href{./arquivos/tab_fisio.csv}{aqui}}.
